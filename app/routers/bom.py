...
from app.models import BOM, Material, User
from app.schemas import BOMCreate, BOMResponse, BOMWithProductResponse, BOMUpdate
...
def create_bom(
    ...
    if existing:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail="该产品的BOM中已存在此物料"
        )
